...
def main():
    ...
    water_edges = np.zeros((num_methods, 97))
    
    method_names = []

    # Detection rates (per sequence)
    detection_rates = np.zeros((num_methods, 6))
    f1_per_sequence = np.zeros((num_methods, 97))
    ...
    colors = ['b', 'r', 'g', 'm', 'y']  # Colors for top-five performing methods
